...
Recently, I have been very interested in the following research topics:
- Explaining the attention mechanism based on Bayesian theory and kernel methods for time series forecasting.
- Optimizing Transformers for spatial-temporal forecasting to improve extreme weather resiliency. 
- Improving Image style transfer performance based on distribution matching and Fourier theory.
- Improving 


Applying 

I mainly teach data science capstone courses for both undergraduate and graduate students and statistical machine learning for graduate students.
